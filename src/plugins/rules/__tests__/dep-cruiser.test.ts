...
describe('depCruiserPlugin', () => {
  ...
  describe('preset module import', () => {
    ...
    it('should be importable via src/configs/index exports', async () => {
      ...
      // Test file is at: src/plugins/rules/__tests__/dep-cruiser.test.ts
      // Configs source is at: src/configs/index.ts
      const packageRoot = path.resolve(__dirname, '../../../..');
      const configsIndexPath = path.join(packageRoot, 'src', 'configs', 'index.ts');
